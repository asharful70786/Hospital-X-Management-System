...
function AdminDashboard() {
  ...
  const quickLinks = [
    { path: "/admin/roles", label: "Role Management", icon: "👨‍💼", color: "indigo" },
    { path: "/admin/departments", label: "Departments", icon: "🏛️", color: "blue" },
    { path: "/admin/bills/summary", label: "Billing Summary", icon: "💰", color: "green" },
    { path: "/admin/records", label: "Patient Records", icon: "📋", color: "purple" },
    { path: "/admin/prescriptions", label: "Prescriptions", icon: "💊", color: "red" },
    { path: "/admin/beds", label: "Bed Management", icon: "🛏️", color: "yellow" },
    { path: "/admin/activity-logs", label: "Activity Logs", icon: "📜", color: "pink" }
  ];
